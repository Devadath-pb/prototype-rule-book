    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          />
          <motion.div
            className="fixed inset-x-0 bottom-0 z-50 mx-auto max-h-[75dvh] w-full max-w-[min(420px,calc(100vw-2rem))] overflow-hidden rounded-t-2xl border border-white/10 bg-[#0c0c0c] shadow-[0_-20px_60px_rgba(0,0,0,0.6)]"
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            exit={{ y: "100%" }}
          ...
          >
            ...
            <div className="max-h-[calc(75dvh-56px)] overflow-y-auto px-4 py-4 sm:px-5">
              {children}
            </div>
          </motion.div>
        </>
