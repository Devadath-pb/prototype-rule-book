...
export default function Header({
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-30 flex items-center justify-between px-4 pt-[env(safe-area-inset-top)]">
      ...
      <div className="pointer-events-auto flex items-center gap-1.5 pt-3">
